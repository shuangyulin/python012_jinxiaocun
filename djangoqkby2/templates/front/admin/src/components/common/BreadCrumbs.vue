<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:40px;backgroundColor:rgba(22, 191, 195, 1);borderRadius:30px;padding:0px 20px 0px 20px;boxShadow:0px 0px 5px 0.5px rgba(167,159,159,1) inset;borderWidth:2px;borderStyle:solid;borderColor:rgba(255, 255, 255, 1);">
