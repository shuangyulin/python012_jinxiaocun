<template>
			<el-main style="padding: 10px 20px;
						background: linear-gradient(86deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 13%, rgba(24,135,171,1) 38%, rgba(24,135,171,1) 44%, rgba(255,255,255,1) 72%, rgba(255,255,255,1) 100%);
