<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">医疗机构药品及耗材信息管理系统+注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">员工电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yuangongdianhua" class="input" type="text" placeholder="员工电话">
			   </div>
			 </div> -->
			<el-form-item label="员工电话" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.yuangongdianhua" autocomplete="off" placeholder="员工电话"  />
			</el-form-item>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220103/7bc406fcd6c54b1d9fe2f50eea855cc9.png);
