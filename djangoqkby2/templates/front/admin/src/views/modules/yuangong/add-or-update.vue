<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工电话" prop="yuangongdianhua">
          <el-input v-model="ruleForm.yuangongdianhua" 
              placeholder="员工电话" clearable  :readonly="ro.yuangongdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工电话" prop="yuangongdianhua">
              <el-input v-model="ruleForm.yuangongdianhua" 
                placeholder="员工电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
