      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '工号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.gonghao" placeholder="工号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.gonghao" placeholder="工号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.gonghao" placeholder="工号" clearable></el-input>
                </el-form-item>
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '员工电话' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.yuangongdianhua" placeholder="员工电话" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.yuangongdianhua" placeholder="员工电话" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.yuangongdianhua" placeholder="员工电话" clearable></el-input>
                </el-form-item>
          <el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="员工姓名">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
                    prop="yuangongdianhua"
                   :header-align="contents.tableAlign"
		    label="员工电话">
		     <template slot-scope="scope">
                       {{scope.row.yuangongdianhua}}
                     </template>
                </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.yuangongdianhua!='' && this.searchForm.yuangongdianhua!=undefined){
            params['yuangongdianhua'] = '%' + this.searchForm.yuangongdianhua + '%'
          }
      this.$http({
        url: "yuangong/page",
        method: "get",
